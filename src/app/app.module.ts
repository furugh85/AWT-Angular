...
import {HttpClient,HttpClientModule, HttpResponse, HTTP_INTERCEPTORS} from '@angular/common/http';
...
import { TokenInterceptor } from './share/token.interceptor';
import { ThesispostsComponent } from './thesisposts/thesisposts.component';
